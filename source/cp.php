...
<body>
    <nav class="navbar">
        ...
        <div class="navbar_right">
            <ul class="navbar_right-list">
                ...
                <li class="navbar_right-item">
                    <a class="navbar_item-content navbar_right-item--selected" href="cp.php">CÀ PHÊ</a>
                </li>
                <li class="navbar_right-item">
    ...
    <article class="content">
        ...
        <div class="content_popular-container">
            <?php 
                $sql = "SELECT * FROM product WHERE `type` = 'cp'";
    ...
    <aside class="aside">
        ...
        <div class="cart" onclick="window.location.href='cart.php?id=<?php echo $user_id?>'">
